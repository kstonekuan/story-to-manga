	...
	return (
		<div className="space-y-6">
			...
			<div className="relative">
				...
				<div
					className={`absolute -top-2 -right-2 border-3 border-black px-3 py-1 font-black text-sm transform rotate-12 ${
						isOverLimit
					...
					<div className="flex items-center gap-3">
						...
						<div>
							...
							<div className="text-sm">
								Story exceeds {maxWords} word limit. Please shorten your story!
							</div>
						</div>
					</div>
				</div>
